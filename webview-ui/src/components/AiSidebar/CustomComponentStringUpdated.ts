...
const returnedComponentString = `const AmazonBlueprint: React.FC = () => {
  return (
    <div style={{ fontFamily: "Arial, sans-serif", margin: 0, padding: 0 }}>
      <header style={{ backgroundColor: "#931921", color: "white", padding: "10px 20px" }}>
        ...
        <section style={{ marginBottom: "30px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "15px" }}>
            <div style={{ backgroundColor: "white", border: "1px solid #ddd", padding: "10px", textAlign: "center" }}>
              ...
              <button style={{ backgroundColor: "#a8b969", border: "none", padding: "8px 12px", cursor: "pointer" }}>
                View Deal
              </button>
            </div>
            <div style={{ backgroundColor: "white", border: "1px solid #ddd", padding: "10px", textAlign: "center" }}>
        ...
        <section style={{ marginBottom: "30px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center" }}>
            <p style={{ flex: 1, minWidth: "250px", fontSize: "16px", lineHeight: "1.5" }}>
              Experience AmazonTEST's seamless shopping interface with curated deals and an intuitive design that makes browsing and purchasing simple.
            </p>
          </div>
        </section>
      </main>
